...
class GeneralConfig:
    ...
    def __init__(self, learn_rate: float, momentum: float, reg: float, dropout=0.5,
        ...
        :param reg: the regularization measure to be used in training
        :param dropout: the dropout probability to be used
        :param summary_interval: the interval of epochs at which the summaries are going to be performed
        :param eval_interval: the interval of epochs at which the evaluations are going to be performed. Must be an
