...
from libs.DCGAN_tensorflow.ops import *
from libs.DCGAN_tensorflow.utils import *
...
class DCGAN(object):
    def __init__(self, sess, input_height=108, input_width=108,
        ...
        self.input_width = input_width if input_width else input_height
        self.output_height = output_height
        self.output_width = output_width if output_width else output_height
        ...
        self.d_optim, self.g_optim = None, None
        self.g_sum, self.d_sum = None, None
    ...
    def create_optimizers(self, learning_rate: float, beta1: float):
        """
        Creates the Optimizers for the generator and discriminator
        :param learning_rate: the learning rate for Adam
        :param beta1: the beta for Adam
        :return: None
        """
    ...
    def train(self, batch_size, model_name, batch_images, batch_labels, increment, iteration):
        ...
        iteration += 1
        print("Increment: [%2d] Iteration: [%4d] time: %4.4f, d_loss: %.8f, g_loss: %.8f"
              % (increment, iteration,
        ...
        if np.mod(iteration, 100) == 1:
            if model_name == const.DATA_MNIST:
                ...
                save_images(samples, image_manifold_size(samples.shape[0]),
                            '../{}/train_{:02d}_{:04d}.png'.format(self.sample_dir, increment, iteration))
