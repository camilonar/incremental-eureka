"""
Experiment for MNIST dataset using the proposed representative-selection algorithm NIL
"""
...
class FashionMnistExperimentNIL(FashionMnistExperiment):
    """
    Performs experiments over FASHION-MNIST dataset using the proposed representative-selection algorithm NIL
    """
    ...
    def _prepare_trainer(self):
        ...
        self.trainer = NILTrainer(self.general_config, self.neural_net, self.data_input,
                                  self.input_tensor, self.output_tensor, tester=tester,
