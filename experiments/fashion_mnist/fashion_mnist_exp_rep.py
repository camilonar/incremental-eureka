...
class FashionMnistExperimentRep(FashionMnistExperiment):
    """
    Performs experiments over FASHION-MNIST dataset using the proposed representative-selection algorithm
    """
