...
class FashionMnistExperimentRILBC(FashionMnistExperiment):
    """
    Performs experiments over FASHION-MNIST dataset using the proposed representative-selection algorithm RILBC
    """
