...
class CifarExperimentRMSProp(CifarExperiment):
    ...
    def _prepare_config(self, str_optimizer: str, train_mode: TrainMode):
        ...
        if train_mode == TrainMode.INCREMENTAL:
            ...
            train_confs = [MegabatchConfig(100, batch_size=128), MegabatchConfig(70, batch_size=128),
                           MegabatchConfig(55, batch_size=128), MegabatchConfig(40, batch_size=128),
                           MegabatchConfig(40, batch_size=128)]
