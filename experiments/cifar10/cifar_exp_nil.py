"""
Experiment for Cifar-10 dataset using the proposed representative-selection algorithm NIL
"""
import copy
...
class CifarExperimentNIL(CifarExperiment):
    """
    Performs experiments over Cifar-10 dataset using the proposed representative-selection algorithm NIL
    """
