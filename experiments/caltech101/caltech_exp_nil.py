"""
Experiment for Caltech-101 dataset using the proposed representative-selection algorithm NIL
"""
import copy
...
class CaltechExperimentNIL(CaltechExperiment):
    """
    Performs experiments over Caltech-101 dataset using the proposed representative-selection algorithm NIL
    """
