"""
Experiment for Caltech-101 dataset using the proposed representative-selection algorithm RILBC
"""
import copy
...
class CaltechExperimentRILBC(CaltechExperiment):
    """
    Performs experiments over Caltech-101 dataset using the proposed representative-selection algorithm RILBC
    """
    ...
    def _prepare_config(self, str_optimizer: str, train_mode: TrainMode):
        self.general_config = CRILConfig(train_mode, 0.0001, self.summary_interval, self.ckp_interval,
                                         ...
                                         n_candidates=20, memory_size=1, buffer_size=1)
