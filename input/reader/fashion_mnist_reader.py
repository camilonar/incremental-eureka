"""
Module for reading the Fashion-MNIST dataset.
"""
from input.reader import Reader


class FashionMnistReader(Reader):
    """
    Reader for fashion-MNIST dataset
    """
    ...
    def get_data(cls):
        ...
        """
        if not cls.data:
            cls.data = FashionMnistReader(cls.__train_dirs, cls.__validation_dir)
        return cls.data
